...
@synthesize roundedRect, closeButton, actionButton, delegate, contentView, contentContainer, backgroundView;
...
- (UIView *)roundedRect {
	if (!roundedRect) {
		...
		[self.contentContainer insertSubview:self.roundedRect atIndex:1];
	}
	return roundedRect;
}
